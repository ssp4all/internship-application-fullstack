...
async function handleRequest(request) {
	return fetch('https://cfw-takehome.developers.workers.dev/api/variants') //request to the API
		...
		.then(res => {
			...
			//initially the person won't, however, we need to check 
			// so next time the person goes to the webapp the 
			// person will go to the variant that they visited before
			let decision;
